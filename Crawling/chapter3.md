...
Sometimes, you still want inheritance to take place when the cascade is preventing it.  To do this, these attributes also come with a special value, `inherit`.  You can assign this value to an element to override any specified value, and it will inherit normally:
